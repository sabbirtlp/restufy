    ...
    return (
        <div>
            ...
            <div className="py-16  bg-gray-100">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg text-black mb-6">
                        Were here to answer any questions you may have. Whether it's about our services or how we can help you,
            ...
            <footer className="footer footer-center bg-base-200 text-base-content rounded p-10">
                ...
                <aside>
                    <p>Copyright © {new Date().getFullYear()} - Designed By Fokira Team Ltd.</p>
                </aside>
            </footer>
        </div>
    );
